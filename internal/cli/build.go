...
type pluginInfo struct {
	// Name of the plugin e.g. github.com/Mark7631/incubator-answer-plugins/github-connector
	Name string
...
func formatPlugins(plugins []string) (formatted []*pluginInfo) {
	for _, plugin := range plugins {
		...
		// plugin description like this 'github.com/Mark7631/incubator-answer-plugins/github-connector@latest=/local/path'
		info := &pluginInfo{}
...
func downloadGoModFile(b *buildingMaterial) (err error) {
	...
	if len(b.answerModuleReplacement) > 0 {
		replacement := fmt.Sprintf("%s=%s", "github.com/Mark7631/incubator-answer", b.answerModuleReplacement)
		err = b.newExecCmd("go", "mod", "edit", "-replace", replacement).Run()
		if err != nil {
			return err
		}
...
func copyUIFiles(b *buildingMaterial) (err error) {
	goListCmd := b.newExecCmd("go", "list", "-mod=mod", "-m", "-f", "{{.Dir}}", "github.com/Mark7631/incubator-answer")
	...
	localUIBuildDir := filepath.Join(b.tmpDir, "vendor/github.com/Mark7631/incubator-answer/ui/")
	...
	pluginsDir := filepath.Join(b.tmpDir, "vendor/github.com/Mark7631/incubator-answer-plugins/")
...
func overwriteIndexTs(b *buildingMaterial) (err error) {
	localUIPluginDir := filepath.Join(b.tmpDir, "vendor/github.com/Mark7631/incubator-answer/ui/src/plugins/")
...
func replaceNecessaryFile(b *buildingMaterial) (err error) {
	...
	uiBuildDir := filepath.Join(b.tmpDir, "vendor/github.com/Mark7631/incubator-answer/ui")
...
func mergeI18nFiles(b *buildingMaterial) (err error) {
	...
	originalI18nDir := filepath.Join(b.tmpDir, "vendor/github.com/Mark7631/incubator-answer/i18n")
...
func buildBinary(b *buildingMaterial) (err error) {
	...
	cmdPkg := "github.com/Mark7631/incubator-answer/cmd"
