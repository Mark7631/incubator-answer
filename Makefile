...
GO_FLAGS=-ldflags="-X github.com/Mark7631/incubator-answer/cmd.Version=$(VERSION) -X 'github.com/Mark7631/incubator-answer/cmd.Revision=$(Revision)' -X 'github.com/Mark7631/incubator-answer/cmd.Time=`date +%s`' -extldflags -static"
